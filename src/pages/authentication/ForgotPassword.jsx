...
import { useForgotPasswordMutation, useLoginMutation } from '../../features/auth/authApi';
	...
	return (
		<div className='flex justify-center items-center min-h-screen '>
			<div className='panel sm:w-[480px] m-6 max-w-lg w-full'>
				...
				<form className='space-y-5 pb-4' onSubmit={handleSubmit(handleFormSubmit)}>
					...
					<button type='submit' className='btn btn-primary w-full bg-slate-900 flex items-center'>
						{isLoading && (
