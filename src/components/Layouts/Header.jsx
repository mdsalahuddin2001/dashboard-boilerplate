...
import { toggleTheme } from "../../features/theme/themeConfigSlice";
      ...
      <div className="shadow-sm">
        <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
          <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
            <Link to="/" className="main-logo flex items-center">
              <svg
                viewBox="0 0 248 31"
            ...
            >
              <HiBars3CenterLeft className="text-white rounded-full  h-6 w-6 bg-secondary p-1" />
            </button>
          </div>
                ...
                <ul className="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                  ...
                  <li className="border-t border-white-light dark:border-white-light/10">
                    <button onClick={logout} className="text-danger !py-3">
                      {isLoading ? (
                        <span className="animate-spin border-2 border-danger border-l-transparent rounded-full w-4 h-4 inline-block align-middle m-0 mr-1.5"></span>
                      ) : (
                        <svg
